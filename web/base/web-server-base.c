...
#define DO_AJAX_CLASS      DO_BASE +  4
#define DO_1WIRE_CLASS     DO_BASE +  5
#define DO_1WIRE_HTML      DO_BASE +  6
#define DO_1WIRE_AJAX      DO_BASE +  7
#define DO_1WIRE_SCRIPT    DO_BASE +  8
#define DO_CLOCK_CLASS     DO_BASE +  9
#define DO_CLOCK_HTML      DO_BASE + 10
#define DO_CLOCK_AJAX      DO_BASE + 11
#define DO_CLOCK_SCRIPT    DO_BASE + 12
#define DO_NET_CLASS       DO_BASE + 13
#define DO_NET_HTML        DO_BASE + 14
#define DO_NET_AJAX        DO_BASE + 15
#define DO_NET_SCRIPT      DO_BASE + 16
#define DO_NET4_HTML       DO_BASE + 17
#define DO_NET4_AJAX       DO_BASE + 18
#define DO_NET4_SCRIPT     DO_BASE + 19
#define DO_NET6_HTML       DO_BASE + 20
#define DO_NET6_AJAX       DO_BASE + 21
#define DO_NET6_SCRIPT     DO_BASE + 22
#define DO_TRACE_HTML      DO_BASE + 23
#define DO_TRACE_AJAX      DO_BASE + 24
#define DO_TRACE_SCRIPT    DO_BASE + 25
#define DO_LOG_HTML        DO_BASE + 26
#define DO_RESET_HTML      DO_BASE + 27
#define DO_FIRMWARE_HTML   DO_BASE + 28
#define DO_FIRMWARE_AJAX   DO_BASE + 29
#define DO_FIRMWARE_SCRIPT DO_BASE + 30
...
int WebServerBaseDecideWhatToDo(char *pPath, char* pLastModified)
{
    ...
    if (                HttpSameStr(pPath, "/ajax-class.js" )) return HttpSameDate(WebAjaxClassDate,      WebAjaxClassTime,      pLastModified) ? DO_NOT_MODIFIED : DO_AJAX_CLASS;
    if (                HttpSameStr(pPath, "/net-class.js"  )) return HttpSameDate(WebNetClassDate,       WebNetClassTime,       pLastModified) ? DO_NOT_MODIFIED : DO_NET_CLASS;
    ...
    if (OneWireInUse && HttpSameStr(pPath, "/1wire-class.js")) return HttpSameDate(WebOneWireClassDate,   WebOneWireClassTime,   pLastModified) ? DO_NOT_MODIFIED : DO_1WIRE_CLASS;
    ...
    if (                HttpSameStr(pPath, "/clock-class.js")) return HttpSameDate(WebClockClassDate,     WebClockClassTime,     pLastModified) ? DO_NOT_MODIFIED : DO_CLOCK_CLASS;
...
bool WebServerBaseReply(int todo)
{
    switch (todo)
    {
        ...
        case DO_AJAX_CLASS:      WebAjaxClass     (); return true;
        ...
        case DO_1WIRE_CLASS:     WebOneWireClass  (); return true;
        ...
        case DO_CLOCK_CLASS:     WebClockClass    (); return true;
        ...
        case DO_NET_CLASS:       WebNetClass      (); return true;
