...
const char* WebOneWireScriptTime = __TIME__;

void WebOneWireScript()
{
    HttpOk("application/javascript; charset=UTF-8", "max-age=3600", WebOneWireScriptDate, WebOneWireScriptTime);
    HttpAddText(script);
}
